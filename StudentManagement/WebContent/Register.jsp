...
.banner-sec{background:url(https://images.pexels.com/photos/235419/pexels-photo-235419.jpeg?w=1260&h=750&auto=compress&cs=tinysrgb)  no-repeat  bottom; background-size:cover; min-height:30px; border-radius: 0 10px 10px 0; padding:0;}
.container{background:#fff; border-radius: 10px; box-shadow:15px 20px 0px rgba(0,0,0,0.1);}
.carousel-inner{border-radius:0 10px 10px 0;}
.carousel-caption{text-align:centre; center:5%;}
...
.register-sec h2{margin-bottom:30px; font-weight:80; font-size:30px; color: #3f4c6b;}
.register-sec h2:after{content:" "; width:100px; height:5px; background:#3f4c6b; display:block; margin-top:20px; border-radius:3px; margin-left:auto;margin-right:auto}
.btn-register{background: #3f4c6b; color:#fff; font-weight:600;}
.banner-text{width:70%; position:absolute; bottom:40px; padding-center:20px;}
...
<section class="register-block">
   ...
   <div class="form-group">
    ...
    <input type="name" class="form-control" placeholder="">
     ...
     <div class="form-group">
    <label for="exampleInputAddress1" class="text-uppercase">Address</label>
